...
<div class="container d-flex justify-content-center containerPrincipal">
    ...
    <form class="containerForm" action="/entraremosemcontatocontato" method="POST">
      @csrf
      <div class="mb-3 ">
      ...
      <div class="mb-3">
        <select class="form-select" id="tipo_suporte" name="tipo_suporte" aria-label="Default select example">
      ...
      <div class="mb-3">
        <div class="form-floating">
          <textarea class="form-control" placeholder="Deixe uma mensagem" id="mensagem" name="mensagem" id="floatingTextarea" style="height: 100px;"></textarea>
