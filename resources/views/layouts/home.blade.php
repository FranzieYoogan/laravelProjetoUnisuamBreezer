              ...
              <div class="collapse navbar-collapse" id="navbarNavDropdown">
                ...
                <div class=" navbar-collapse">
                  ...
                  <ul class="navbar-nav mr-auto ">
                    ...
                    <li class="nav-item">
                      <a class="nav-link " aria-current="page" href=""><i class="fa-solid fa-building"></i>
                        Empresas</a>
                    </li>
                ...
                <div class="divMenu2  navbar-collapse navPositioning">
                  <ul class="navbar-nav">
                    <li class="nav-item">
                      <a class="nav-link " href="https://api.whatsapp.com/send?phone=552130301010&text=%23Comercial"><i
          ...
          <nav class="navbar navbar-expand-lg " style="background-color: #CA1C2A;">
            <div class="container-fluid d-flex " >
              <a class="navbar-brand" href="/"><img
                  src="https://bbl245.p3cdn1.secureserver.net/wp-content/uploads/2022/10/cropped-navbartelecall-e1664888635140.png"
                  alt="" height="60px"></a>
              <button class="navbar-toggler" type="button"  data-bs-toggle="collapse"
              ...
              <div class="container text-center text-md-start mt-5">
                ...
                <div class="row mt-3">
                  ...
                  <div class="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
                    ...
                    <p style="color: white;">
                      A Telecall é uma operadora de telecomunicações brasileira que oferece a seus clientes o mais
                      alto padrão de qualidade, velocidade e acessibilidade em soluções de comunicação. Serviços que
                      incluem uma ampla gama de valores agregados, oferecendo aos clientes operações mais produtivas,
                      inovadoras e eficazes. Com mais de 20 anos de experiência na indústria global, a Telecall hoje é
